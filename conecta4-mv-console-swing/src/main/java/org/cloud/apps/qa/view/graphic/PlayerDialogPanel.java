...
public class PlayerDialogPanel extends JPanel implements ActionListener {
	...
	public PlayerDialogPanel() {
	    super();
	    this.setLayout(new GridBagLayout());
	    this.setSize(500,500);
	    this.setBorder(BorderFactory.createLineBorder(Color.black));
	    players = new String[Conecta4.getNumPlayers()];
	...
	public void actionPerformed(ActionEvent e) {
		System.out.println("evento players");
